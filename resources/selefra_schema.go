...
// func TableSchemaGenerator_auth0_attack_protection() (*schema.Table, *schema.Diagnostics) {
//     diagnostics := schema.NewDiagnostics()

//     table, d := GetResource_auth0_attack_protection().ToTable(func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) *bridge.TerraformBridge {
//         return taskClient.(*Client).TerraformBridge
//     })
//     if diagnostics.AddDiagnostics(d).HasError() {
//         return nil, diagnostics
...
//     table.Columns = GetColumns_auth0_attack_protection()
//     if len(table.Columns) == 0 {
//         return nil, diagnostics.AddErrorMsg("")
//     }
...
// // auth0_attack_protection
// func GetColumns_auth0_attack_protection() []*schema.Column {
//     return []*schema.Column{ 
//         table_schema_generator.NewColumnBuilder().ColumnName("brute_force_protection").ColumnType(schema.ColumnTypeJSON).Description("Brute-force protection safeguards against a single IP address attacking a single user account.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("suspicious_ip_throttling").ColumnType(schema.ColumnTypeJSON).Description("Suspicious IP throttling blocks traffic from any IP address that rapidly attempts too many logins or signups.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("id").ColumnType(schema.ColumnTypeString).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("breached_password_detection").ColumnType(schema.ColumnTypeJSON).Description("Breached password detection protects your applications from bad actors logging in with stolen credentials.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("selefra_terraform_original_result").ColumnType(schema.ColumnTypeJSON).Description("save terraform original result for compatibility").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//     }
...
// func TableSchemaGenerator_auth0_email_template() (*schema.Table, *schema.Diagnostics) {
//     diagnostics := schema.NewDiagnostics()

//     table, d := GetResource_auth0_email_template().ToTable(func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) *bridge.TerraformBridge {
//         return taskClient.(*Client).TerraformBridge
//     })
//     if diagnostics.AddDiagnostics(d).HasError() {
//         return nil, diagnostics
...
//     table.Columns = GetColumns_auth0_email_template()
//     if len(table.Columns) == 0 {
//         return nil, diagnostics.AddErrorMsg("")
//     }
...
// // auth0_email_template
// func GetColumns_auth0_email_template() []*schema.Column {
//     return []*schema.Column{ 
//         table_schema_generator.NewColumnBuilder().ColumnName("enabled").ColumnType(schema.ColumnTypeBool).Description("Indicates whether the template is enabled.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("id").ColumnType(schema.ColumnTypeString).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("include_email_in_redirect").ColumnType(schema.ColumnTypeBool).Description("Whether the `reset_email` and `verify_email` templates should include the user's email address as the email parameter in the `returnUrl` (true) or whether no email address should be included in the redirect (false). Defaults to `true`.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("template").ColumnType(schema.ColumnTypeString).Description("Template name. Options include `verify_email`, `verify_email_by_code`, `reset_email`, `welcome_email`, `blocked_account`, `stolen_credentials`, `enrollment_email`, `mfa_oob_code`, `user_invitation`, `change_password` (legacy), or `password_reset` (legacy).").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("url_lifetime_in_seconds").ColumnType(schema.ColumnTypeFloat).Description("Number of seconds during which the link within the email will be valid.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("body").ColumnType(schema.ColumnTypeString).Description("Body of the email template. You can include [common variables](https://auth0.com/docs/customize/email/email-templates#common-variables).").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("result_url").ColumnType(schema.ColumnTypeString).Description("URL to redirect the user to after a successful action. [Learn more](https://auth0.com/docs/customize/email/email-templates#configure-template-fields).").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("subject").ColumnType(schema.ColumnTypeString).Description("Subject line of the email. You can include [common variables](https://auth0.com/docs/customize/email/email-templates#common-variables).").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("syntax").ColumnType(schema.ColumnTypeString).Description("Syntax of the template body. You can use either text or HTML with Liquid syntax.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("from").ColumnType(schema.ColumnTypeString).Description("Email address to use as the sender. You can include [common variables](https://auth0.com/docs/customize/email/email-templates#common-variables).").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("selefra_terraform_original_result").ColumnType(schema.ColumnTypeJSON).Description("save terraform original result for compatibility").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//     }
// }
...
// // auth0_branding
// func TableSchemaGenerator_auth0_branding() (*schema.Table, *schema.Diagnostics) {
//     diagnostics := schema.NewDiagnostics()

//     table, d := GetResource_auth0_branding().ToTable(func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) *bridge.TerraformBridge {
//         return taskClient.(*Client).TerraformBridge
//     })
//     if diagnostics.AddDiagnostics(d).HasError() {
//         return nil, diagnostics
...
//     table.Columns = GetColumns_auth0_branding()
//     if len(table.Columns) == 0 {
//         return nil, diagnostics.AddErrorMsg("")
//     }
...
// // auth0_branding
// func GetColumns_auth0_branding() []*schema.Column {
//     return []*schema.Column{ 
//         table_schema_generator.NewColumnBuilder().ColumnName("id").ColumnType(schema.ColumnTypeString).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("logo_url").ColumnType(schema.ColumnTypeString).Description("URL of logo for branding.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("colors").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for colors for branding.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("font").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings to customize the font.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("universal_login").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for Universal Login.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("favicon_url").ColumnType(schema.ColumnTypeString).Description("URL for the favicon.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("selefra_terraform_original_result").ColumnType(schema.ColumnTypeJSON).Description("save terraform original result for compatibility").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//     }
// }
...
// auth0_tenant
// func TableSchemaGenerator_auth0_tenant() (*schema.Table, *schema.Diagnostics) {
//     diagnostics := schema.NewDiagnostics()

//     table, d := GetResource_auth0_tenant().ToTable(func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) *bridge.TerraformBridge {
//         return taskClient.(*Client).TerraformBridge
//     })
//     if diagnostics.AddDiagnostics(d).HasError() {
//         return nil, diagnostics
...
//     table.Columns = GetColumns_auth0_tenant()
//     if len(table.Columns) == 0 {
//         return nil, diagnostics.AddErrorMsg("")
//     }
...
// // auth0_tenant
// func GetColumns_auth0_tenant() []*schema.Column {
//     return []*schema.Column{ 
//         table_schema_generator.NewColumnBuilder().ColumnName("id").ColumnType(schema.ColumnTypeString).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("support_email").ColumnType(schema.ColumnTypeString).Description("Support email address for authenticating users.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("support_url").ColumnType(schema.ColumnTypeString).Description("Support URL for authenticating users.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("change_password").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for change password page.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("error_page").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for error pages.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("default_redirection_uri").ColumnType(schema.ColumnTypeString).Description("The default absolute redirection URI. Must be HTTPS or an empty string.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("default_audience").ColumnType(schema.ColumnTypeString).Description("API Audience to use by default for API Authorization flows. This setting is equivalent to appending the audience to every authorization request made to the tenant for every application.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("enabled_locales").ColumnType(schema.ColumnTypeJSON).Description("Supported locales for the user interface. The first locale in the list will be used to set the default locale.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("idle_session_lifetime").ColumnType(schema.ColumnTypeFloat).Description("Number of hours during which a session can be inactive before the user must log in again.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("sandbox_version").ColumnType(schema.ColumnTypeString).Description("Selected sandbox version for the extensibility environment, which allows you to use custom scripts to extend parts of Auth0's functionality.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("session_lifetime").ColumnType(schema.ColumnTypeFloat).Description("Number of hours during which a session will stay valid.").Build(), 
...
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("friendly_name").ColumnType(schema.ColumnTypeString).Description("Friendly name for the tenant.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("picture_url").ColumnType(schema.ColumnTypeString).Description("URL of logo to be shown for the tenant. Recommended size is 150px x 150px. If no URL is provided, the Auth0 logo will be used.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("flags").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for tenant flags.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("guardian_mfa_page").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for the Guardian MFA page.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("default_directory").ColumnType(schema.ColumnTypeString).Description("Name of the connection to be used for Password Grant exchanges. Options include `auth0-adldap`, `ad`, `auth0`, `email`, `sms`, `waad`, and `adfs`.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("universal_login").ColumnType(schema.ColumnTypeJSON).Description("Configuration settings for Universal Login.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("session_cookie").ColumnType(schema.ColumnTypeJSON).Description("Alters behavior of tenant's session cookie. Contains a single `mode` property.").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("selefra_terraform_original_result").ColumnType(schema.ColumnTypeJSON).Description("save terraform original result for compatibility").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//     }
...
// func TableSchemaGenerator_auth0_connection_client() (*schema.Table, *schema.Diagnostics) {
//     diagnostics := schema.NewDiagnostics()

//     table, d := GetResource_auth0_connection_client().ToTable(func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) *bridge.TerraformBridge {
//         return taskClient.(*Client).TerraformBridge
//     })
//     if diagnostics.AddDiagnostics(d).HasError() {
//         return nil, diagnostics
...
//     table.Columns = GetColumns_auth0_connection_client()
//     if len(table.Columns) == 0 {
//         return nil, diagnostics.AddErrorMsg("")
//     }
...
// // auth0_connection_client
// func GetColumns_auth0_connection_client() []*schema.Column {
//     return []*schema.Column{ 
//         table_schema_generator.NewColumnBuilder().ColumnName("id").ColumnType(schema.ColumnTypeString).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("name").ColumnType(schema.ColumnTypeString).Description("The name of the connection on which to enable the client.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("strategy").ColumnType(schema.ColumnTypeString).Description("The strategy of the connection on which to enable the client.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("client_id").ColumnType(schema.ColumnTypeString).Description("ID of the client for which the connection is enabled.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("connection_id").ColumnType(schema.ColumnTypeString).Description("ID of the connection on which to enable the client.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("selefra_terraform_original_result").ColumnType(schema.ColumnTypeJSON).Description("save terraform original result for compatibility").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//     }
// }
...
// func TableSchemaGenerator_auth0_prompt_custom_text() (*schema.Table, *schema.Diagnostics) {
//     diagnostics := schema.NewDiagnostics()

//     table, d := GetResource_auth0_prompt_custom_text().ToTable(func(ctx context.Context, clientMeta *schema.ClientMeta, taskClient any, task *schema.DataSourcePullTask) *bridge.TerraformBridge {
//         return taskClient.(*Client).TerraformBridge
//     })
//     if diagnostics.AddDiagnostics(d).HasError() {
//         return nil, diagnostics
...
//     table.Columns = GetColumns_auth0_prompt_custom_text()
//     if len(table.Columns) == 0 {
//         return nil, diagnostics.AddErrorMsg("")
//     }
...
// // auth0_prompt_custom_text
// func GetColumns_auth0_prompt_custom_text() []*schema.Column {
//     return []*schema.Column{ 
//         table_schema_generator.NewColumnBuilder().ColumnName("body").ColumnType(schema.ColumnTypeString).Description("JSON containing the custom texts. You can check the options for each prompt [here](https://auth0.com/docs/customize/universal-login-pages/customize-login-text-prompts#prompt-values).").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("id").ColumnType(schema.ColumnTypeString).Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("language").ColumnType(schema.ColumnTypeString).Description("Language of the custom text. Options include: `ar`, `bg`, `bs`, `cs`, `da`, `de`, `el`, `en`, `es`, `et`, `fi`, `fr`, `fr-CA`, `fr-FR`, `he`, `hi`, `hr`, `hu`, `id`, `is`, `it`, `ja`, `ko`, `lt`, `lv`, `nb`, `nl`, `pl`, `pt`, `pt-BR`, `pt-PT`, `ro`, `ru`, `sk`, `sl`, `sr`, `sv`, `th`, `tr`, `uk`, `vi`, `zh-CN`, `zh-TW`.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("prompt").ColumnType(schema.ColumnTypeString).Description("The term `prompt` is used to refer to a specific step in the login flow. Options include: `common`, `consent`, `device-flow`, `email-otp-challenge`, `email-verification`, `invitation`, `login`, `login-id`, `login-password`, `login-passwordless`, `login-email-verification`, `logout`, `mfa`, `mfa-email`, `mfa-otp`, `mfa-phone`, `mfa-push`, `mfa-recovery-code`, `mfa-sms`, `mfa-voice`, `mfa-webauthn`, `organizations`, `reset-password`, `signup`, `signup-id`, `signup-password`.").Build(), 
//         table_schema_generator.NewColumnBuilder().ColumnName("selefra_terraform_original_result").ColumnType(schema.ColumnTypeJSON).Description("save terraform original result for compatibility").
//         Extractor(column_value_extractor.TerraformRawDataColumnValueExtractor()).Build(), 
//     }
// }
